...
unit_3 = create_unit(player_2)
unit_4 = create_unit(player_2)

battle = init_battle(player_1,player_2)
...
for(var xx=0;xx<ds_list_size(player_1.units);xx++) {
	...
	for(var xx=0;xx<ds_list_size(player_2.units);xx++) {
		var unit = player_2.units[| xx]
		/*unit.x = cell_w * 1.3
		unit.y = cell_h * (2.5 + xx)
		unit.start_x = unit.x
		unt.start_y = unit.y*/
